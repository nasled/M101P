...
def create_user(username, password):
    try:
        ...
        print("create_user Exception: ", type(e), e)
        return False
...
def try_to_login(username, password):
    try:
        ...
        print("try_to_login Exception: ", type(e), e)
        return False
...
# Trying to create a test user  ygLUJMZ
# Found the test user  ygLUJMZ  in the users collection
# User creation successful.
# Trying to login for test user  ygLUJMZ
